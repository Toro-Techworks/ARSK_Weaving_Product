...
class YarnReceiptController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'colour' => GenericCode::validationRule('colour', false, GenericCode::DROPDOWN_TYPE_MASTER, 64),
    ...
    public function bulkStore(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            'yarn_receipts.*.colour' => GenericCode::validationRule('colour', false, GenericCode::DROPDOWN_TYPE_MASTER, 64),
